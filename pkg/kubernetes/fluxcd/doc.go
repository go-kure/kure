...
// notification stack (Provider, Alert, Receiver), image automation
// (ImageUpdateAutomation), and objects from the Flux operator (FluxInstance,
// FluxReport, ResourceSet, ResourceSetInputProvider).
//
// # Constructors
//
