...
runs: it imports this package as `certmanager`, `github.com/go-kure/kure/pkg/kubernetes`, the
upstream APIs as `certv1 "github.com/cert-manager/cert-manager/pkg/apis/certmanager/v1"`,
`cmacme "github.com/cert-manager/cert-manager/pkg/apis/acme/v1"` and
`cmmeta "github.com/cert-manager/cert-manager/pkg/apis/meta/v1"`,
`metav1 "k8s.io/apimachinery/pkg/apis/meta/v1"`, `k8s.io/utils/ptr`, `time`, and `fmt` for the
line that prints what the example built.
...
<!-- doc-example: pkg/kubernetes/certmanager ExampleCreateCertificate -->
```go
...
<!-- doc-example: pkg/kubernetes/certmanager ExampleCreateCertificate_spec -->
```go
...
<!-- doc-example: pkg/kubernetes/certmanager ExampleSetIssuerACME -->
```go
...
<!-- doc-example: pkg/kubernetes/certmanager ExampleAddACMEIssuerSolver -->
```go
issuer := certmanager.CreateIssuer("letsencrypt", "default")
...
<!-- doc-example: pkg/kubernetes/certmanager ExampleCreateIssuer_otherArms -->
```go
...
<!-- doc-example: pkg/kubernetes/certmanager ExampleSetClusterIssuerCA -->
```go
...
<!-- doc-example: pkg/kubernetes/certmanager ExampleAddCertificateDNSName -->
```go
cert := certmanager.CreateCertificate("my-cert", "default")
issuer := certmanager.CreateIssuer("letsencrypt", "default")
