...
type BootstrapConfig struct {
	...
	// Flux-specific
	FluxMode        string   `yaml:"fluxMode,omitempty" json:"fluxMode,omitempty"` // "flux-operator" (default) or "gotk" (legacy)
	...
	SourceKind string `yaml:"sourceKind,omitempty" json:"sourceKind,omitempty"` // "GitRepository" or "OCIRepository"
