...
func AddClusterLabel(obj *cnpgv1.Cluster, key, value string) error {
...
func AddClusterAnnotation(obj *cnpgv1.Cluster, key, value string) error {
	v := validation.NewValidator()
	if err := v.ValidateCluster(obj); err != nil {
		return err
	}
...
func AddClusterManagedRole(obj *cnpgv1.Cluster, role cnpgv1.RoleConfiguration) error {
	v := validation.NewValidator()
	if err := v.ValidateCluster(obj); err != nil {
		return err
	}
