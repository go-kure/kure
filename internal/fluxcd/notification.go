...
// and specification.
func CreateProvider(name, namespace string, spec notificationv1beta3.ProviderSpec) *notificationv1beta3.Provider {
...
func CreateAlert(name, namespace string, spec notificationv1beta3.AlertSpec) *notificationv1beta3.Alert {
...
// namespace and specification.
func CreateReceiver(name, namespace string, spec notificationv1.ReceiverSpec) *notificationv1.Receiver {
