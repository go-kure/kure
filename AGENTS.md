...
| **A4** | No merge-ready claim without per-item evidence. For kure: `mise run verify` (tidy, lint, test) or `make precommit`, plus code-and-docs in the same PR per `docs/standards.md`. | Step 5, with output quoted rather than asserted |
