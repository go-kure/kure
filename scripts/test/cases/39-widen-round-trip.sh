...
# raises the upper bound and appends to the notes, and a subsequent
...
assert_rc 0
assert_out_contains 'range-dep: supported_range widened to "2.0 - 2.1"; note appended to the existing notes'
